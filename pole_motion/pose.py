...
Cosa fa:
- keypoint del corpo per fotogramma (MediaPipe Pose Landmarker, Tasks API)
...
Nel progetto originale il nome della mossa veniva assegnato da `vision.py`
(modello multimodale locale) sui pochi fotogrammi di focus.

CLI:  python -m pole_motion.pose --video clip.mp4 --out preview.mp4
"""
